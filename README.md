...
Навчальний MLOps-проєкт, що реалізує наскрізний конвеєр: від тренування ML-моделі до її розгортання як публічного REST API.
...
Проєкт демонструє ключові практики MLOps:
...
В результаті у корені проєкту з'явиться файл `model.joblib`, а в консолі буде виведено accuracy на тестовій вибірці (очікувано ~0.97).
